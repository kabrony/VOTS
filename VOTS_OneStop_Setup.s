...
# that include the LATEST openai (1.59.6 as of early 2025), google-genai, chromadb,
# gradio, langchain, etc.
#
...
# Attempt to unify the conflicting websockets usage:
# google-genai 0.2.1 requires websockets >=13.0,<15.0dev
# Some versions of gradio also want websockets <13.0, but 4.53.0 should be okay with 13.x.
# We'll do websockets==13.4.2 for now.
...
# The latest openai package on PyPI as of early 2025
openai==1.59.6
...
# Additional forced pin to unify websockets version
websockets==13.4.2
EOF
